...
import pickle
import os
from utilis import drawPolygons, label_detection, save_parking_status, sahi_detection, get_detction_info, load_json


def run_detection(json_file = "paths_and_idx.json"):
    # Load paths, idx_list, and url_list from the JSON file
    data  = load_json(json_file)
    idx_list = data["parking_monitoring_cameras"]
